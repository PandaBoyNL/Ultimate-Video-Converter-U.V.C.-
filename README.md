...
A sleek, lightweight Python & FFmpeg-powered WebUI to batch-convert your video libraries directly from your Unraid server disks with smart folder navigation and automated notifications.
...
* **Fire-and-Forget Background Processing:** Start a conversion batch queue and safely close the browser tab. The container runs continuously on the background.
...
## 📡 Support & Feedback
If you run into any issues, have feature requests, or want to suggest improvements, feel free to open an Issue on this GitHub repository!
